...
# node input parameters
params = [{'name': 'set_output_folder', 'out_dirpath': '/home/luca/eodc/repos/openeo/eodc-openeo-bindings/tests/output_udf_python/result/'}, {'name': 'save_raster', 'format_type': 'VRT'}]
