...
p3_10 = PythonOperator(task_id='p3_10',
                        dag=dag,
                        python_callable=EODataProcessor,
                        op_kwargs={'filepaths': None, 'dc_filepaths': ['/openeo_job/div_9/div_9.dc'], 'user_params': [{'name': 'set_output_folder', 'out_dirpath': '/openeo_job/p3_10/'}, {'name': 'reduce', 'dimension': 'band', 'f_input': {'f_name': 'product', 'extra_values': '[2.5];list'}}, {'name': 'to_pickle', 'filepath': '/openeo_job/p3_10/p3_10.dc;str'}]},
                        queue='process'
                        )
...
min_12 = PythonOperator(task_id='min_12',
                        dag=dag,
                        python_callable=EODataProcessor,
                        op_kwargs={'filepaths': None, 'dc_filepaths': ['/openeo_job/evi_1/evi_1.dc'], 'user_params': [{'name': 'set_output_folder', 'out_dirpath': '/openeo_job/min_12/'}, {'name': 'reduce', 'dimension': 'time', 'f_input': {'f_name': 'min'}}, {'name': 'to_pickle', 'filepath': '/openeo_job/min_12/min_12.dc;str'}]},
                        queue='process'
                        )
...
save_13 = PythonOperator(task_id='save_13',
                        dag=dag,
                        python_callable=EODataProcessor,
                        op_kwargs={'filepaths': None, 'dc_filepaths': ['/openeo_job/mintime_11/mintime_11.dc'], 'user_params': [{'name': 'set_output_folder', 'out_dirpath': '/openeo_job/result/'}, {'name': 'save_raster', 'format_type': 'VRT'}, {'name': 'get_cube_metadata'}, {'name': 'to_pickle', 'filepath': '/openeo_job/result/save_13.dc;str'}]},
                        queue='process'
                        )
