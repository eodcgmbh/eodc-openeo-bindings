...
p3_10 = eoDataReadersOp(task_id='p3_10',
                        ...
                        input_params=[{'name': 'set_output_folder', 'out_dirpath': '/home/luca/eodc/repos/openeo/eodc-openeo-bindings/tests/openeo_job/p3_10/'}, {'name': 'reduce', 'dimension': 'band', 'f_input': {'f_name': 'eo_product', 'extra_values': '[2.5];list'}}, {'name': 'save_raster', 'format_type': 'VRT'}],
                        queue='process'
                        )
...
min_12 = eoDataReadersOp(task_id='min_12',
                        ...
                        input_params=[{'name': 'set_output_folder', 'out_dirpath': '/home/luca/eodc/repos/openeo/eodc-openeo-bindings/tests/openeo_job/min_12/'}, {'name': 'reduce', 'dimension': 'time', 'f_input': {'f_name': 'eo_min'}}, {'name': 'save_raster', 'format_type': 'VRT'}],
                        queue='process'
                        )
