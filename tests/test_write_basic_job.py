...
def test_basic(csw_server, test_folder, evi_file, out_filepath_basic, backend_processes):
...
def test_UC1_temporal_basic(acube_csw_server, test_folder, uc1_temporal_file, out_filepath_basic):
    job_data = os.path.join(test_folder, 'basic_job')
...
def test_UC1_spectral_basic(acube_csw_server, test_folder, uc1_spectral_file, out_filepath_basic):
    job_data = os.path.join(test_folder, 'basic_job')
    backend_processes = 'https://openeo.eodc.eu/v1.0/processes'
